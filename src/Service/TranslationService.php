...
class TranslationService implements TranslationServiceInterface
{
    ...
    public function updateTranslation(string $languageKey, string $translationKey, string $translationValue): Translation
    {
        ...
        return $this->writeTranslation($aLang, $languageKey, $translationKey, $translationFile);
    }
    ...
    private function writeTranslation(array $aLang, string $languageKey, string $translationKey, string $translationFile): Translation
    {
        $content = '<?php
